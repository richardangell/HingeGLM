...
#' to fit in another model. A shortcoming of this approach is it is likely
#' to choose to keep consecutive betas that alternate signs, which
#' intuitively would appear to be noice caused from having few obervations
#' in a single bucket. This can be mitigated somewhat be using equal weight
#' rather than equal width buckets. Another draw back is that this is a
#' parametric technique relying on the value of eta.
#'
...
#'
#' @export
ramer_douglas_peucker_betas <- function(df, eta) {
